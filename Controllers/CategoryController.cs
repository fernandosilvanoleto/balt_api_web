...
public class CategoryController : ControllerBase {
    ...
    public async Task<ActionResult<List<Category>>> Get([FromServices]DataContext context){
        var categories = await context.Categories.AsNoTracking().ToListAsync(); //AsNoTracking retorna mais rápido

        return Ok(categories);
    }

    [HttpGet]
    [Route("{id:int}")] // RESTRIÇÃO DE ROTAS => TPERMITINDO PARÂMETROS SOMENTE COM VALORES INT
    [AllowAnonymous]
